...
function ema_modal_window_admin_style($hook) {
	...
	wp_enqueue_style(  'ema_modal_css', 		plugins_url('coursepress-reorder-pages-css.css', __FILE__) );
	...
	wp_enqueue_script( 'ema_reorder_script', 	plugin_dir_url( __FILE__ ) . 'coursepress-reorder-pages-js.js', array(), '1.0' );
	
	wp_enqueue_script( 'ema_modal_script', 		plugin_dir_url( __FILE__ ) . 'coursepress-reorder-pages-modalWindow-js.js', array(), '1.0', true );
			...
			<div class="ema-modal">
				...
				<div class="ema-modal-body">
					<section class="ema-modal-content">
						<p class="ema-red-alert">Neuordnen ist eine vorübergehende Lösung für CoursePress</p>
